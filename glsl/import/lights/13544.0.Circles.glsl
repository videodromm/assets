...
void main(void)
{
	...
	Circle13544_circle ( .03 , vec3 ( 0.7 , 0.2*sin(iGlobalTime) , 0.8 ) , vec2 ( .6 ) , vec2 ( .30 , .20 ) );
	Circle13544_circle ( .05 , vec3 ( 0.7 , 0.9 , 0.6*cos(iGlobalTime) ) , vec2 ( .6 ) , vec2 ( .30 , .20 ) );
	Circle13544_circle ( .07 , vec3 ( 0.3*sin(iGlobalTime) , 0.4 , 0.1 ) , vec2 ( .6 ) , vec2 ( .30 , .20 ) );
	Circle13544_circle ( .10 , vec3 ( 0.2 , 0.5 , cos(iGlobalTime+.2) ) , vec2 ( .6 ) , vec2 ( .30 , .20 ) );
	Circle13544_circle ( .20 , vec3 ( 0.1 , 0.3 , sin(iGlobalTime+10.)-cos(iGlobalTime+20.) ) , vec2 ( .6 ) , vec2 ( .30 , .20 ) );
	Circle13544_circle ( .30 , vec3 ( 0.9 , cos(iGlobalTime) , 0.2 ) , vec2 ( .6 ) , vec2 ( .30 , .20 ) );
	Circle13544_circle ( .15 , abs(vec3 ( sin(iGlobalTime) , 0.4 , 0.2 )) , vec2 ( .3 ) , vec2 ( .30 , .20 ) );
	Circle13544_color+=bkgd*(abs(sin(iGlobalTime/5.))+.3);
