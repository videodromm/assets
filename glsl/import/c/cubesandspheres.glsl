...
void main(void){
  ...
  c2=c2*max(1.0-f*.1,0.0);
   ...
   //vec3 col = vec3(finalCol.x*iColor.x,finalCol.y*iColor.x,0.1);
    //gl_FragColor = vec4(col,1.0);

  //vec4 col = vec4(c1.xyz*0.99+c2.xyz*0.50,1.0);


  vec4 col = vec4(c1.x*iColor.x+c2.x*iColor.x,c1.y*iColor.y+c2.y*iColor.y,c1.z*iColor.z+c2.z*iColor.z,1.0);
